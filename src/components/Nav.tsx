        ...
        {(canSubmitGuest || canSubmitFreelancer) && (
          <div className="relative shrink-0">
            {canSubmitGuest && !canSubmitFreelancer ? (
              <Link
                href="/submit"
                className="inline-flex items-center gap-1.5 rounded-lg bg-sky-600 px-2.5 py-1.5 text-xs sm:text-sm font-medium text-white shadow-sm transition-colors hover:bg-sky-700 dark:bg-sky-500 dark:hover:bg-sky-400 dark:shadow-sky-500/20"
              >
