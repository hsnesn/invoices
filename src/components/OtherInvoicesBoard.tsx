...
export function OtherInvoicesBoard({
  ...
  return (
    <div className="space-y-4 text-slate-800 dark:text-slate-100 max-w-full min-w-0 overflow-x-hidden">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 mb-2">
        ...
        <div className="flex flex-wrap items-center gap-2 min-w-0">
          <button
            ...
            className={`rounded-xl px-3 py-2 text-sm font-medium shadow-sm transition-all flex items-center gap-1.5 ${showDashboard ? "bg-slate-800 text-white" : "bg-slate-100 text-slate-700 hover:bg-slate-200 dark:bg-slate-700 dark:text-slate-200"}`}
          >
          ...
          <div ref={columnsAnchorRef}>
            <button
              ...
              className="rounded-xl bg-slate-100 px-3 py-2 text-sm font-medium text-slate-700 shadow-sm hover:bg-slate-200 dark:bg-slate-700 dark:text-slate-200 flex items-center gap-1.5"
            >
              <svg className="h-4 w-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
      ...
      {selectedIds.size > 0 && (
        <div
          className="fixed bottom-6 left-1/2 z-40 -translate-x-1/2 flex flex-wrap items-center gap-3 rounded-2xl border-2 border-blue-500 bg-blue-50 px-4 py-3 shadow-xl dark:border-blue-400 dark:bg-blue-950/50"
