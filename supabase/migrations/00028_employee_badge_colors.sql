...
UPDATE employees SET full_name = 'Guy-Aldric Watine', badge_color = '#ed1c24' WHERE LOWER(email_address) IN ('guy-aldric.watine@trtworld.com', 'guy.watine@trtworld.com');
